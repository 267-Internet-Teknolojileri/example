...
*
* @version  0.2.5
    <div class="maps-area" style="height:450px;"><div id="mapser" class="mapser"></div></div>
    <script src="https://maps.googleapis.com/maps/api/js?v=3.22&sensor=false&key=AIzaSyB-lsyy0LaAIOCmwsLjyy4PeiR-b5OPpQg"></script> <!--&key=KEY_GÝRMEYÝ_UNUTMAYINIZ!!!-->
